...
export const metadata = { title: "EduGuard · Academic assistance", description: "Private, local Bloom-aware academic assistance", manifest: "/manifest.webmanifest", icons: { icon: "/framework-icon.svg" } };
