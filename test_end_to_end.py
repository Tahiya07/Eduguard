"""
End-to-end test of target level rewrite with real Qwen model.
Tests all six Bloom levels using the problematic test case.
"""
...
def test_all_bloom_levels():
    """Test target rewrite for all six Bloom levels."""
    try:
    ...
    print("=" * 80)
    print("END-TO-END TARGET LEVEL REWRITE TEST")
    print("=" * 80)
    print()
