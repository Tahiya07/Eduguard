    ...
    return [
        ...
        ExperimentSpec(
            ...
            command=[
                ...
                "fedprox_iid_dp",
                "--output",
                f"{r}/artifacts/federated/results/federated_dp_fedprox_iid.json",
                "--global-adapter",
                f"{r}/artifacts/federated/models/qwen_bloom_federated0.5B_fedprox_iid_dp",
                "--noise-multiplier",
                "1.0",
                "--target-delta",
                "1e-5",
            ...
            expected_outputs=[f"{r}/artifacts/federated/results/federated_dp_fedprox_iid.json"],
            gate="dp_validated",
            blocking=False,
