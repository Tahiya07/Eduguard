"""
Test with the actual bloom_prompt but adjusted to ensure question output.
"""
...
def test_adjusted_prompt():
    """Test with adjusted prompt."""
    print("Testing with adjusted prompt...")
    ...
    # Adjusted prompt - simpler but with the key instructions
    adjusted_prompt = f"""<|im_start|>system
